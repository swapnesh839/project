...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r p-8 from-indigo-600 to-purple-600 flex items-center justify-center text-white">
      <div className="text-center space-y-6">
        ...
        <div className="flex items-center flex-col md:flex-row justify-center space-y-3 md:space-y-0 md:space-x-3">
          <Button
            className="text-white px-6 py-3 rounded-lg bg-indigo-600 hover:bg-indigo-600/70 hover:scale-[1.05] font-semibold transition-all duration-500 shadow-md border border-indigo-700"
        ...
        <div className="lex items-center flex-col md:flex-row justify-center space-y-3 md:space-y-0 md:space-x-3">
          <Button
            className="text-white px-6 py-3 rounded-lg bg-indigo-600 hover:bg-indigo-600/70 hover:scale-[1.05] font-semibold transition-all duration-500 shadow-md border border-indigo-700"
            onClick={() =>
